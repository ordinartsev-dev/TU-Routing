...
namespace Backend.Services
{
    public class TransitRouteService
    {
        ...
        public async Task<TransitRoute> CalculateTransitRouteAsync(double fromLat, double fromLon, double toLat, double toLon)
        {
            try
            {
                string url = $"http://localhost:8000/api/routes?from={fromLat},{fromLon}&to={toLat},{toLon}&stopovers=true";
